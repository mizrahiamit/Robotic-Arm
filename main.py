...
class Form(QWidget):
    def __init__(self, parent=None, **kwargs):
        ...
        self._iterations = 100 #MAX iterations allowed  - After N max iterations, the program will stop.
        self._error_miss_detection = 20# Max iterations that the program don't detect the arm - After N max iterations, the program will stop.
        ...
        #parameters to check if setup has changed
        ...
        #How many times each point was not recognised - For debug only
        self._shoulder_miss=0
        self._elbow_miss=0
        self._wrist_miss=0
        #The arm radius when both parts of the arm are stright - compute at the "check system" stage
        self._arm_radius = 0.00
        #------------------------------------------
        #Target Coordinates - Chosen by the user
        self._x_pos = 0
        self._y_pos = 0
        #------------------------------------------
        #------------------------------------------
        ...
        #------------------------------------------
        #System control input - By those parameters the program will calculate the next step for the arm. 
        self._deviation = 640.0 #The distance between the wirst to destination - Will change has the cycle of the loop
        self._distance = 0 #The distance between the shoulder to the destination
        #------------------------------------------
        #------------------------------------------
        #------------------------------------------
        #Msg that tell the user what the next action required
        ...
        #------------------------------------------
        #Only after the setup is approved by the program, The buttons could be used.
        ...
        #Get pixel coordinates by right click on the mouse - Only when start butten enabeled
        ...
        self.setWindowTitle("Camera Controlled XY Robotic Arm")


    #------------------------------------------------------------
    #------------------------------------------------------------
    #------------------------------------------------------------
    #The method will check if all three points on the arm are recognize.
    #if not, show msg: to try again
    #if yes, Let the user to proceed, by enabling start button
    def check_clicked(self):
        ...
        if (self._shoulder_pos==(None,None)) or (self._elbow_pos==(None,None)) or (self._wrist_pos==(None,None)):  
            ...
            return True
    #------------------------------------------------------------
    #The method will check if the user coordinates are possible to reach,
    #if no, will show msg: that the coordinate out of rach
    #and tell the user to pick new coordinates
    #if yes, Start the "loopGenerator" (program algorithem)
    ...
    #------------------------------------------------------------
    #The method suspend the "loopGenerator" untill anthor button is pressed
    def pause_clicked(self):
        ...
        print "Pause clicked"
    #------------------------------------------------------------
    #The method stop "loopGenerator",
    #and the user can choose a new coordinates
    ...
    #------------------------------------------------------------
    #------------------------------------------------------------
    #The method return the user choise of coordinates on the image,
    #Only if start button is enabeld
